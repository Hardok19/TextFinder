...
public class Sorting {
    ...
    public static void main(String[] args) {
        // Crear una lista grande de objetos Result con diferentes fileNames, fileTimes y fileSizes
        List<Result> results = new ArrayList<>();
        results.add(new Result("fileC.txt", "C:/docs/fileC.txt", 15, FileTime.fromMillis(System.currentTimeMillis())));
        results.add(new Result("fileA.txt", "C:/docs/fileA.txt", 10, FileTime.fromMillis(System.currentTimeMillis() - 100000)));
        results.add(new Result("fileB.txt", "C:/docs/fileB.txt", 5, FileTime.fromMillis(System.currentTimeMillis() + 50000)));
        results.add(new Result("fileD.txt", "C:/docs/fileD.txt", 20, FileTime.fromMillis(System.currentTimeMillis() + 100000)));
        // Agregar más resultados para asegurar la robustez del sort
        for (int i = 1; i <= 11; i++) {
            results.add(new Result("fileZ" + i + ".txt", "C:/extra/fileZ" + i + ".txt", i * 2, FileTime.fromMillis(System.currentTimeMillis() - i * 10000)));
        }
